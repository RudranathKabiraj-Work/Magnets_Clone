...
export default function LeadMagnetAnalyticsPage() {
  ...
  const visits = page?.views || 0;
  const signups = page?.signups || 0;
  const conversionRate = visits > 0 ? ((signups / visits) * 100).toFixed(1) + "%" : "0.0%";
        ...
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-extrabold flex items-center gap-2 text-white">
                ...
                <span
                  ...
                  title="Track real-time visits, signups, and conversion metrics for this lead magnet."
                >
                  ?
                </span>
              </h1>
              <p className="text-xs text-zinc-400 mt-1 font-medium">
                {page?.name || page?.headline || "BDA"}
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#18181B] p-5 space-y-3 shadow-sm">
              ...
              <div>
                <div className="text-3xl font-black text-white">{visits}</div>
            ...
            <div className="rounded-2xl border border-zinc-800 bg-[#18181B] p-5 space-y-3 shadow-sm">
              ...
              <div>
                <div className="text-3xl font-black text-white">{signups}</div>
                <div className="text-[11px] text-zinc-500 mt-1 font-medium">
                  {signups} unique people · 0 in the last 30 days
                </div>
              </div>
            </div>
