  ...
  return (
    <DashboardShell account={account} title="Hosted resource">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-10">
        ...
        <div className="relative mt-8 rounded-lg border border-dashed border-ink-300 bg-white p-12 text-center transition hover:border-ink-400 dark:border-ink-700 dark:bg-ink-900">
          <input
            type="file"
            className="absolute inset-0 cursor-pointer opacity-0"
            onChange={handleSimulatedUpload}
        ...
        {/* Info Banner */}
        <div className="mt-6 flex items-start gap-3 rounded-lg border border-ink-200 bg-ink-50 p-3.5 text-xs text-ink-600 dark:border-ink-800 dark:bg-ink-950/20 dark:text-ink-400">
