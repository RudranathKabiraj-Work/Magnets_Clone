...
export default function Home() {
  return (
    <main className="overflow-hidden bg-[#F0F7FF] dark:bg-[#0B0F17] text-zinc-900 dark:text-zinc-100 transition-colors duration-300">
      <script
      ...
      <section className="relative mx-auto max-w-7xl px-5 pb-20 pt-12 sm:px-8 sm:pt-20 lg:px-10 lg:pb-28">
        ...
        <Reveal className="relative z-10 mx-auto max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#0066B2]/20 dark:border-[#0066B2]/40 bg-white dark:bg-[#161D2A] px-3.5 py-1.5 text-xs font-semibold text-[#0066B2] dark:text-[#38BDF8] shadow-sm">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3.5 sm:flex-row">
            ...
            <a
              className="inline-flex h-12 items-center justify-center rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#161D2A] px-6 text-base font-bold text-zinc-700 dark:text-zinc-200 shadow-sm transition hover:bg-zinc-50 dark:hover:bg-zinc-800"
              href="#how-it-works"
            >
              See how it works
            </a>
      ...
      <section className="border-y border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-[#0E131F]" id="features">
      ...
      <section className="bg-[#080C14] dark:bg-[#05080E] py-20 text-white sm:py-28" id="how-it-works">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          <Reveal className="max-w-2xl">
            <p className="text-xs font-bold uppercase tracking-wider text-[#38BDF8]">Simple by default</p>
            <h2 className="mt-3 text-3xl sm:text-4xl font-extrabold leading-[1.1] text-white tracking-tight">
          ...
          <div className="mt-12 grid divide-y divide-white/10 border-y border-white/10 lg:grid-cols-3 lg:divide-x lg:divide-y-0">
            <Reveal delay={0} className="min-w-0 py-8 sm:py-10 lg:pl-0 lg:pr-12">
              <span className="font-mono text-xs font-bold text-[#38BDF8]">{steps[0].number}</span>
              <h3 className="mt-4 text-xl font-bold text-white">{steps[0].title}</h3>
              <p className="mt-2.5 max-w-xs text-xs sm:text-sm leading-relaxed text-zinc-400">{steps[0].body}</p>
            </Reveal>
            <Reveal delay={0.1} className="min-w-0 py-8 sm:py-10 lg:px-12">
              <span className="font-mono text-xs font-bold text-[#38BDF8]">{steps[1].number}</span>
              <h3 className="mt-4 text-xl font-bold text-white">{steps[1].title}</h3>
              <p className="mt-2.5 max-w-xs text-xs sm:text-sm leading-relaxed text-zinc-400">{steps[1].body}</p>
            </Reveal>
            <Reveal delay={0.2} className="min-w-0 py-8 sm:py-10 lg:pl-12 lg:pr-0">
              <span className="font-mono text-xs font-bold text-[#38BDF8]">{steps[2].number}</span>
              <h3 className="mt-4 text-xl font-bold text-white">{steps[2].title}</h3>
              <p className="mt-2.5 max-w-xs text-xs sm:text-sm leading-relaxed text-zinc-400">{steps[2].body}</p>
            </Reveal>
          </div>
        </div>
      </section>

      <section className="bg-[#F0F7FF] dark:bg-[#0B0F17] py-20 sm:py-28" id="integrations">
        <div className="mx-auto grid max-w-7xl items-start gap-12 px-5 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20 lg:px-10">
          ...
          <Reveal delay={0.12}>
            <div className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#121824] p-6 shadow-xl sm:p-8">
      ...
      <section className="border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#0E131F] px-5 py-20 sm:px-8 sm:py-24 lg:px-10">
        <Reveal className="mx-auto max-w-4xl">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {faqs.map((faq) => (
              <article key={faq.question} className="rounded-2xl border border-zinc-200/80 dark:border-zinc-800 bg-[#F0F7FF] dark:bg-[#161D2A] p-5 shadow-xs">
      ...
      <section className="border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#0B0F17] px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
