...
export const metadata: Metadata = {
  title: "Terms",
  description: "Magnets Terms of Service.",
  robots: { index: true, follow: true },
  alternates: { canonical: "https://magnets.so/terms" },
};
    ...
    <main className="min-h-screen bg-brand-soft text-ink-900">
      ...
      <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <article className="prose-magnets mt-10 space-y-8 text-[15px] leading-7 text-ink-700">
          <p>
            These Terms govern your use of Magnets (the &ldquo;Service&rdquo;). By creating an account, publishing a page, or
          ...
          <LegalSection title="1. What Magnets does">
            <p>
              Magnets lets you create branded lead-magnet pages, collect signups, deliver resources by email, and optionally run
              follow-up emails and connected integrations. Pages may be hosted at a Magnets URL or, if you choose, on a custom
              domain you connect. Magnets may be offered free of charge or with different plans and features over time.
            </p>
          </LegalSection>
          ...
          <LegalSection title="3. Sending email">
            <p>
              Magnets can send a resource email from a Magnets-managed sender address so you can get started without setting up a
          ...
          <LegalSection title="5. Optional integrations">
            <p>
              ...
              and Cal.com. If you do, you authorise Magnets to send the information needed to perform the selected action, such as
          ...
          <LegalSection title="6. Your content and your subscribers">
            <p>
              You retain ownership of the pages, copy, images, resources, and other content you submit to Magnets. You give us the
          ...
          <LegalSection title="8. Third-party services">
            <p>
              Magnets relies on third-party providers for hosting, storage, authentication, email delivery, and integrations. We do
          ...
          <LegalSection title="10. Disclaimer and limitation of liability">
            <p>
              To the maximum extent permitted by law, Magnets is provided without warranties of any kind, whether express, implied,
          ...
          <LegalSection title="11. Ending use">
            <p>
              You may stop using Magnets at any time. You can request or use the dashboard controls to delete your account. We may
          ...
          <LegalSection title="12. Changes to these Terms">
            <p>
              We may update these Terms as Magnets changes. If a change is material, we will provide reasonable notice before it
          ...
          <LegalSection title="13. Governing law and contact">
            <p>
              ...
              sent to <a className="text-ink-900 underline-offset-4 hover:underline" href="mailto:hello@magnets.so">hello@magnets.so</a>.
            </p>
          </LegalSection>
        </article>
