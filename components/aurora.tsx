...
void main() {
  ...
  // Smoothly fade alpha near top and bottom viewport edges to eliminate dark line borders
  float edgeFade = smoothstep(1.0, 0.80, uv.y) * smoothstep(0.0, 0.08, uv.y);
  float alpha = clamp(auroraAlpha * 0.65 * edgeFade, 0.0, 0.75);
